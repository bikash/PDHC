...
import org.apache.hadoop.hdfs.server.namenode.BackupState;
...
public class CheckerN extends NameNode {
  ...
  URL nnHttpAddress;
  /** Checkpoint manager */
  org.apache.hadoop.hdfs.server.namenode.Checkpointer checkpointManager;
  
  CheckerN(Configuration conf, NamenodeRole role) throws IOException {
    super(conf, role);
  }

  /////////////////////////////////////////////////////
  // Common NameNode methods implementation for checker node.
  /////////////////////////////////////////////////////
  @Override // NameNode
