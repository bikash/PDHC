...
/**
 *This will securely overwrite the data and delete the content
 */
...
class TrueDelete {
  ...
  public static class Rm extends FsCommand {
    public static final String NAME = "trm";
  ...
  /** remove any path */
  static class TRmr extends Rm {
    public static final String NAME = "trmr";
